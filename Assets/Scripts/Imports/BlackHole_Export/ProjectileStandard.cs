...
namespace Unity.FPS.Gameplay
{
    public class ProjectileStandard : ProjectileBase
    {
        ...
        bool IsHitValid(RaycastHit hit)
        {
            ...
            // ignore hits with triggers that don't have a Damageable component or AbsorbPortal component
            if (hit.collider.isTrigger && hit.collider.GetComponent<Damageable>() == null && hit.collider.GetComponent<AbsorbPortal>() == null)
            {
                return false;
            }
        ...
        {
            // check for absorb portal
            AbsorbPortal portal = collider.GetComponent<AbsorbPortal>();
            if (portal != null)
            {
                portal.AbsorbProjectile(this);
